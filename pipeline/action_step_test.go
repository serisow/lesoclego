...
func TestActionStepImpl_Execute(t *testing.T) {
    ...
    registry.RegisterActionService("create_article_action", &CreateArticleAction{})
    registry.RegisterActionService("update_entity_action", &UpdateEntityAction{})
